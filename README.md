<<<<<<< HEAD
# Trendify - Clothing E-commerce Platform

Trendify is a full-stack clothing e-commerce project with customer storefront and admin management tools.

## Tech Stack
- Frontend: React, Vite, Tailwind CSS, React Router, Axios
- Backend: Node.js, Express, Mongoose, JWT, bcrypt, Cloudinary
- Database: MongoDB

## Project Structure
- frontend: Customer + admin UI
- backend: API, authentication, authorization, business logic

## Features
- Customer: authentication, products, search, filters, cart, checkout, wishlist, orders, profile, reviews
- Admin: login, dashboard analytics, product CRUD, image upload, order management, users, coupons, sales reports
...
Update values in both env files for your environment.
...
- Configure MONGO_URI, JWT_SECRET, CORS_ORIGINS, Cloudinary, Razorpay keys

### Database
- Use MongoDB Atlas in production
- Restrict DB user permissions and network access
...
## SEO
- Meta tags, Open Graph tags, and JSON-LD are configured in frontend HTML shell
- robots.txt and sitemap.xml are available in frontend/public

## Testing
- Backend test command is available: npm test
- Add unit/integration/e2e suites for critical flows before production launch

## License
Internal project for educational/commercial use.
=======
