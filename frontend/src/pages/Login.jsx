    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="neu-card w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="font-display font-bold text-3xl text-text-heading">Welcome Back</h1>
          <p className="text-text-muted text-sm mt-2">Sign in to your Trendify account</p>
        </div>
        ...
        <div className="flex items-center justify-between text-sm text-text-muted mt-6 mb-4">
